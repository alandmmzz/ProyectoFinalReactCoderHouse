...
export default function ItemDetail({ item }) {
    ...
    function finishPurchaseButton({condition}){
        return (
            <>
            <Button className={condition < 1? 'btn btn-dark disabled rounded-3 mt-2':'btn btn-dark rounded-3 mt-2'}>Finalizar compra</Button>
            </>
        )
    }
